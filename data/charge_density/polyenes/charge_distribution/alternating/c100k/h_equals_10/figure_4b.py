...
linear_conductor_q = np.genfromtxt('classical_values_heq10.csv')
...
axs.legend(loc='best', frameon=False, title=r"$\mathrm{(a): \ \mathit{h}=10 \ a_{0}}$")
axs.set_xlabel(r"$\mathit{y} \ (a_{0})$")
axs.set_ylabel(r"$\mathit{q} \ (e)$")
plt.savefig("charge_dist_alternating_heq10_zoom.png",dpi=300,bbox_inches='tight')