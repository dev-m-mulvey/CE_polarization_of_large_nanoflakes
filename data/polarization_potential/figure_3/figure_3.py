...
axs.scatter(z,impot,color="black",s=2000,linestyle='-',marker="s",label=r"$\mathrm{-6.8028/z}$") 
...
axs.plot(x_dat,func(x_dat,*popt),color="red",markersize=2,linewidth=8,linestyle='-',label=r"$\mathrm{{MMA1:{:.4f}/z}}$".format(popt[0]))
axs.plot(x_dat,func(x_dat,*popt2),color="green",markersize=2,linewidth=8,linestyle='-',label=r"$\mathrm{{MMA2:{:.4f}/z}}$".format(popt2[0]))
axs.scatter(z,MMA1,color="red",s=2000,marker="o")
